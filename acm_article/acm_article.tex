...
\hypertarget{pretty-graph}{%
\section{Pretty graph}\label{pretty-graph}}

\begin{figure}

{\centering \includegraphics{acm_article_files/figure-pdf/fig-example-1.pdf}

}

\caption{\label{fig-example}An example figure}

\end{figure}

This is an example of adding some content to our paper. We made a nice
graph in Figure~\ref{fig-example}.

Let's talk maths.. \(E=mc^2\).
